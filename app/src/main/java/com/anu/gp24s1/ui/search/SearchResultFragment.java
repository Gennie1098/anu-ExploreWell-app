...
public class SearchResultFragment extends Fragment {
    ...
    private PostListViewModel searchViewModel;
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        searchViewModel = new ViewModelProvider(requireActivity()).get(PostListViewModel.class);
        String searchWords = getArguments().getString("searchWords");
        List<PostVo> postVos = UserSession.getInstance().searchPosts(searchWords);
        searchViewModel.setPostVoListData(postVos);
